...
const ExperienceDatas: Array<ExperienceItemProp> = [
    {
        ...
        "description": "migration application to new tech stack which improves application responsiveness. reduce infrastructure cost, delivery robust performance & more maintainable codebase & decrease error rate.",
        skills: ["go", "elasticsearch", "redis", "kibana", "circleci"]
    },
    {
    ...
    },
    {
        ...
        skills: ["python", "postgres", "aws", "microservice", "rabbitmq"]
    },
    {
